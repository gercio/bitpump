...
public class SimulationActionDeciderTest {
    ...
    public void testIt() {
        ...
        SimulationActionDecider actionTrigger =  new SimulationActionDeciderBuilder().withParameters(parameters).withNumberOfHistoricalTransactionsToRunSimulation(10).withWalletToSupplier(() -> new TradeWalletTO(10, 10)).build();
